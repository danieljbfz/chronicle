...
func TestWriteStatsText_includesTotalsByProviderAndTopProjects(t *testing.T) {
	...
	for _, want := range []string{
		...
		"By provider",
		"claude: 100 sessions, 10,000 messages, 4.0MB across 3 project(s)",
		"copilot: 50 sessions, 2,345 messages, 1.0MB across 2 project(s)",
		"Top 2 project(s) by session count",
		"/Users/x/work/foo",
		"ws-bar",
